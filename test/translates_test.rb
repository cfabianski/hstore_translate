...
class TranslatesTest < HstoreTranslate::Test
  ...
  def test_assigns_in_specified_locale
    I18n.with_locale(:en) do
      p = Post.new(title_translations: { 'en' => 'English Title' },
                   body_1_translations: { 'en' => 'English Body' })
  ...
  def test_assigns_blank_value_when_active
    ...
    I18n.with_locale(:en) do
      p = PostDetailed.new(comment_translations: { 'en' => 'English Comment' },
                           title_translations: { 'en' => 'English Comment' })
      p.comment_fr = ''
      p.comment = ''
      p.title_en = nil
      p.title = nil
  ...
  def test_persists_changes_in_specified_locale
    I18n.with_locale(:en) do
      p = Post.create!(title_translations: { 'en' => 'Original Text' },
                       body_1_translations: { 'en' => 'Original Body' })
  ...
  def test_fallback_from_empty_string
    ...
    p = Post.new(title_translations: { 'en' => 'English Title', 'fr' => '' },
                 body_1_translations: { 'en' => 'English Body', 'fr' => '' })
    I18n.with_locale(:fr) do
      assert_equal('English Title', p.title)
      assert_equal('English Body', p.body_1)
  ...
  def test_persists_translations_assigned_to_localized_accessors
    p = Post.create!(title_en: 'English Title', title_fr: 'Titre français', body_1_en: 'English Body',
                     body_1_fr: 'Corps anglais')
    p.reload
    assert_equal({ 'en' => 'English Title', 'fr' => 'Titre français' }, p.title_translations)
    assert_equal({ 'en' => 'English Body', 'fr' => 'Corps anglais' }, p.body_1_translations)
  end
  ...
  def test_permitted_translated_attributes
    assert_equal %i[title_en title_fr body_1_en body_1_fr comment_en comment_fr],
                 PostDetailed.permitted_translated_attributes
  end
end
