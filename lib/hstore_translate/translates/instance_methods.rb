...
module HstoreTranslate
  module Translates
    module InstanceMethods
      ...
      def read_hstore_translation(attr_name, locale = I18n.locale, fallback = true, **params)
        translations = public_send("#{attr_name}#{SUFFIX}") || {}

        selected_locale = locale
        if fallback
          selected_locale = hstore_translate_fallback_locales(locale).detect do |available_locale|
      ...
      def write_hstore_translation(attr_name, value, locale = I18n.locale, allow_blank: false)
