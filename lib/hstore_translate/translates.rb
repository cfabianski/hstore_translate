    ...
    def translates(*attrs, allow_blank: false)
      ...
      attrs.each do |attr_name|
        define_method attr_name do |**params|
          read_hstore_translation(attr_name, **params)
        end

        define_method "#{attr_name}=" do |value|
          write_hstore_translation(attr_name, value, allow_blank: allow_blank)
        end
        ...
        I18n.available_locales.each do |locale|
          ...
          define_method :"#{attr_name}_#{normalized_locale}" do |**params|
            read_hstore_translation(attr_name, locale, false, **params)
          end

          define_method "#{attr_name}_#{normalized_locale}=" do |value|
            write_hstore_translation(attr_name, value, locale, allow_blank: allow_blank)
          end
        end
